    ...
    children: [
      {
        ...
        to: { name: 'template-pages-user-profile-tab', params: { tab: 'profile' } },
      },
      {
        title: 'Account Settings',
        icon: { icon: 'tabler-settings' },
        to: { name: 'template-pages-account-settings-tab', params: { tab: 'account' } },
      },
      { title: 'FAQ', icon: { icon: 'tabler-help' }, to: 'template-pages-faq' },
      { title: 'Pricing', icon: { icon: 'tabler-diamond' }, to: 'template-pages-pricing' },
      {
        title: 'Misc',
        icon: { icon: 'tabler-cube' },
        children: [
          { title: 'Coming Soon', to: 'template-pages-misc-coming-soon' },
      ...
      { title: 'Dialog Examples', icon: { icon: 'tabler-square' }, to: 'template-pages-dialog-examples' },
      {
        title: 'Front Pages',
