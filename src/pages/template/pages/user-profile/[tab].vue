...
definePage({
  meta: {
    navActiveLink: 'template-pages-user-profile-tab',
    key: 'tab',
  },
})

const route = useRoute('template-pages-user-profile-tab')
  ...
  <div>
    ...
    >
      <VTab
        ...
        :key="item.icon"
        :value="item.tab"
        :to="{ name: 'template-pages-user-profile-tab', params: { tab: item.tab } }"
      >
        <VIcon
          size="20"
          start
