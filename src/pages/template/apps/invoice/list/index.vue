...
const computedMoreList = computed(() => {
  return paramId => [
    ...
    },
    {
      ...
      to: {
        name: 'template-apps-invoice-edit-id',
        params: { id: paramId },
      },
    },
    {
    ...
    <VCard id="invoice-list">
        ...
        <div class="d-flex gap-4 align-center flex-wrap">
          ...
          <VBtn
            prepend-icon="tabler-plus"
             :to="{ name: 'template-apps-invoice-add' }"
          >
            Create invoice
          </VBtn>
        </div>
      ...
      >
        ...
        <template #item.id="{ item }">
          <RouterLink :to="{ name: 'template-apps-invoice-preview-id', params: { id: item.id } }">
            #{{ item.id }}
          </RouterLink>
        </template>
        ...
        <template #item.actions="{ item }">
          ...
          <IconBtn :to="{ name: 'template-apps-invoice-preview-id', params: { id: item.id } }">
